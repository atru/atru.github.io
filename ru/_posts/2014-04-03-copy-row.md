...
<img width="100%" alt="Успешно скопировали строку" src="/img/2014/copyrow_02.png" style="cursor:pointer" onclick="window.open('/img/2014/copyrow_02.png','_blank');return;"></img>
